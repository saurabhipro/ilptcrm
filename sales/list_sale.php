    ...
    <script type="text/javascript">
		...
		$(document).ready(function()			
		{
		    ...
		    $('#create-product').click(function(){
		        changePageTitle('Create Sales');
		        $('#loader-image').show();
		        $('#create-product').hide();
		        $('#read-products').show();
		        $('#page-content').fadeOut('slow', function(){
		            $('#page-content').load('create_sale_form.php', function(){
		                $('#loader-image').hide(); 
		...
		$(document).on('click', '.edit-btn', function(){ 
		    changePageTitle('Update Sales');
		    var sale_id = $(this).closest('td').find('.product-id').text();
		    $('#loader-image').show();
		    $('#create-product').hide();
		    $('#read-products').show();
		    $('#page-content').fadeOut('slow', function(){
		        $('#page-content').load('update_form.php?sale_id=' + sale_id, function(){
		            $('#loader-image').hide(); 
		            $('#page-content').fadeIn('slow');
		        });
		    });
...
<body>
 ...
 <div class="container">
        ...
        <div class='page-header'>
            <h1 id='page-title'>Search Sales</h1>
        </div>

        <div class='margin-bottom-1em overflow-hidden'>
        <!-- when clicked, it will show the product's list -->
         <a href="./excel_import.php" > <input type="button" value="Download Excel" class="btn btn-primary"></a>
         

		    <div id='read-products' class='btn btn-primary pull-right display-none'>
		        <span class='glyphicon glyphicon-list'></span> Read Sales
		    </div>
