    ...
    <script type="text/javascript">
		...
		$(document).ready(function()			
		{
		    ...
		    $('#create-product').click(function(){
		        changePageTitle('Create Targets');
		        $('#loader-image').show();
		        $('#create-product').hide();
		        $('#read-products').show();
		        $('#page-content').fadeOut('slow', function(){
		            $('#page-content').load('create_target_form.php', function(){
		                $('#loader-image').hide(); 
			...
			$(document).on('click', '.delete-btn', function(){
				if(confirm('Are you sure?')){
					var sale_id = $(this).closest('td').find('.product-id').text();
					$.post("delete.php", { id: sale_id })
						.done(function(data){
							console.log(data);
							$('#loader-image').show();
							showProducts();
		...
		$(document).on('click', '.edit-btn', function(){ 
		    changePageTitle('Update Targets');
		    var target_id = $(this).closest('td').find('.product-id').text();
		    $('#loader-image').show();
		    $('#create-product').hide();
		    $('#read-products').show();
		    $('#page-content').fadeOut('slow', function(){
		        $('#page-content').load('update_form.php?target_id=' + target_id, function(){
		            $('#loader-image').hide(); 
		            $('#page-content').fadeIn('slow');
		        });
		    });
