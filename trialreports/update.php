...
$machined_part= new MachinedPart($db);
$tool= new Tool($db);
...
if($m9 = "S" or $m9 = "U"  or $m9 = "Z" ){
    ...
    $q2 = $d64_2*$d62_2*$d67_2;
}

if($m9 = "F" ){$q1 = ($d66_1*$d67_1*$d68_1)/1000;$q2 = ($d66_2*$d67_2*$d68_2)/1000;}
...
$machined_part->type =$_POST['type'];
$machined_part->load_mp =$_POST['load_mp'];
$machined_part->techn_conditions =$_POST['techn_conditions'];
$machined_part->name_mp =$_POST['name_mp'];
$machined_part->requested_roughness =$_POST['requested_roughness'];
$machined_part->workpiece =$_POST['workpiece'];
$machined_part->group_mp =$_POST['group_mp'];
$machined_part->strength =$_POST['strength'];
$machined_part->hardness_hb =$_POST['hardness_hb'];
$machined_part->hardness_hrc = $_POST['hardness_hrc'];
...
$trial_report->id=$_POST['id'];
$machined_part->id=$_POST['id'];
$tool->id=$_POST['id'];
$cutting_conditions->id=$_POST['id'];
$evaluation->id=$_POST['id'];
$tool_spending->id=$_POST['id'];


$trial_report->update();
$machined_part->update();
$tool->update();
$cutting_conditions->update();
$evaluation->update();
$tool_spending->update();

exit(header("Location: list_trial_report.php"));
