        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.delete-btn', function () {
                if (confirm('Are you sure?')) {
                    var user_id = $(this).closest('td').find('.product-id').text();
...
<div class="container">
    ...
    <h2 class='bs-callout bs-callout-warning'>List Users</h2>
